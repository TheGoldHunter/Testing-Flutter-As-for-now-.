...
class DataAbsenScreen extends StatelessWidget {
  const DataAbsenScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF05050A), // Deep dark cyber background
      body: SafeArea(
        child: Column(
          children: [
